...
class InkcollectorCLI:
    ...
    def _download_card_images(self, lorcast: LorcastAPI, cards: List[Dict[str, Any]], set_id: str, image_size: str = 'normal') -> None:
    ...
    def _download_single_card_image(self, lorcast: LorcastAPI, card: Dict[str, Any], output_path: str, image_size: str = 'normal') -> bool:
        ...
        if not image_uri:
            print(f"No {image_size} image URI found for card {card_id}, skipping image download.")
            return False
